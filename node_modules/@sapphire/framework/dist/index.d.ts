...
import { ChatInputApplicationCommandData, UserApplicationCommandData, MessageApplicationCommandData, ApplicationCommandManager, Collection, ApplicationCommand, Snowflake, Message, ChatInputCommandInteraction, ContextMenuCommandInteraction, ChannelType, PermissionsBitField, CommandInteraction, TextBasedChannel, PermissionResolvable, AutocompleteInteraction, DMChannel, CategoryChannel, NewsChannel, ThreadChannel, TextChannel, StageChannel, VoiceChannel, GuildMember, Role, User, PermissionsString, ClientOptions, Interaction, Client, ClientEvents, Events as Events$1, Guild, PartialDMChannel } from 'discord.js';
...
export { AliasPiece, AliasPieceOptions, AliasStore, LoaderError, LoaderPieceContext, MissingExportsError, Piece, PieceContext, PieceOptions, Store, StoreOptions, StoreRegistry, StoreRegistryEntries, container } from '@sapphire/pieces';
...
declare const index_d$1_parseConstructorPreConditionsCooldown: typeof parseConstructorPreConditionsCooldown;
declare const index_d$1_parseConstructorPreConditionsNsfw: typeof parseConstructorPreConditionsNsfw;
declare const index_d$1_parseConstructorPreConditionsRequiredClientPermissions: typeof parseConstructorPreConditionsRequiredClientPermissions;
declare const index_d$1_parseConstructorPreConditionsRequiredUserPermissions: typeof parseConstructorPreConditionsRequiredUserPermissions;
declare const index_d$1_parseConstructorPreConditionsRunIn: typeof parseConstructorPreConditionsRunIn;
declare namespace index_d$1 {
  export {
    index_d$1_parseConstructorPreConditionsCooldown as parseConstructorPreConditionsCooldown,
    index_d$1_parseConstructorPreConditionsNsfw as parseConstructorPreConditionsNsfw,
    index_d$1_parseConstructorPreConditionsRequiredClientPermissions as parseConstructorPreConditionsRequiredClientPermissions,
    index_d$1_parseConstructorPreConditionsRequiredUserPermissions as parseConstructorPreConditionsRequiredUserPermissions,
    index_d$1_parseConstructorPreConditionsRunIn as parseConstructorPreConditionsRunIn,
  };
}
...
declare const index_d_resolveGuild: typeof resolveGuild;
...
declare namespace index_d {
  export {
    ...
    index_d_resolveGuild as resolveGuild,
