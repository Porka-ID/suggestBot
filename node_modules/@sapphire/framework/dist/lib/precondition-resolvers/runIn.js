...
var Command_js = require('../structures/Command.js');
...
function parseConstructorPreConditionsRunIn(runIn, resolveConstructorPreConditionsRunType, preconditionContainerArray) {
  if (utilities.isNullish(runIn))
    return;
  if (Command_js.Command.runInTypeIsSpecificsObject(runIn)) {
    ...
    if (messageRunTypes !== null || chatInputRunTypes !== null || contextMenuRunTypes !== null) {
      preconditionContainerArray.append({
        name: Enums_js.CommandPreConditions.RunIn,
        context: {
          types: {
    ...
    if (types !== null) {
      preconditionContainerArray.append({ name: Enums_js.CommandPreConditions.RunIn, context: { types } });
    }
  }
}
