...
var index_js = require('../precondition-resolvers/index.js');
...
var _Command = class _Command extends pieces.AliasPiece {
  ...
  async reload() {
    ...
    if (updatedPiece.registerApplicationCommands) {
      try {
        ...
        registriesErrors_js.emitPerRegistryError(err, updatedPiece);
        return;
      }
    }
  ...
  parseConstructorPreConditionsNsfw(options) {
    index_js.parseConstructorPreConditionsNsfw(options.nsfw, this.preconditions);
  }
  /**
  ...
  parseConstructorPreConditionsRunIn(options) {
    index_js.parseConstructorPreConditionsRunIn(options.runIn, this.resolveConstructorPreConditionsRunType.bind(this), this.preconditions);
  }
  /**
  ...
  parseConstructorPreConditionsRequiredClientPermissions(options) {
    index_js.parseConstructorPreConditionsRequiredClientPermissions(options.requiredClientPermissions, this.preconditions);
  }
  /**
  ...
  parseConstructorPreConditionsRequiredUserPermissions(options) {
    index_js.parseConstructorPreConditionsRequiredUserPermissions(options.requiredUserPermissions, this.preconditions);
  }
  /**
  ...
  parseConstructorPreConditionsCooldown(options) {
    index_js.parseConstructorPreConditionsCooldown(
      this,
