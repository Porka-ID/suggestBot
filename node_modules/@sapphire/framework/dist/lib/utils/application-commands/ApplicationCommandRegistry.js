...
var _ApplicationCommandRegistry = class _ApplicationCommandRegistry {
  ...
  registerChatInputCommand(command, options) {
    ...
    this.apiCalls.push({
      ...
      registerOptions: options ?? {
        ...
        behaviorWhenNotIdentical: ApplicationCommandRegistries_js.getDefaultBehaviorWhenNotIdentical(),
  ...
  getGuildIdsToRegister(options) {
    ...
    } else if (!utilities.isNullishOrEmpty(ApplicationCommandRegistries_js.getDefaultGuildIds())) {
      guildIdsToRegister = ApplicationCommandRegistries_js.getDefaultGuildIds();
    }
