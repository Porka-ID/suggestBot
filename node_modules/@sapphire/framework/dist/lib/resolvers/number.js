...
function resolveNumber(parameter, options) {
  ...
  if (Number.isNaN(parsed)) {
    return result.Result.err(Identifiers_js.Identifiers.ArgumentNumberError);
  }
  if (typeof options?.minimum === "number" && parsed < options.minimum) {
    return result.Result.err(Identifiers_js.Identifiers.ArgumentNumberTooSmall);
  }
  if (typeof options?.maximum === "number" && parsed > options.maximum) {
    return result.Result.err(Identifiers_js.Identifiers.ArgumentNumberTooLarge);
  }
