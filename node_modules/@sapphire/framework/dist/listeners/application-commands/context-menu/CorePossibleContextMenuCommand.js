...
var _CoreListener = class _CoreListener extends Listener_js.Listener {
  constructor(context) {
    super(context, { event: Events_js.Events.PossibleContextMenuCommand });
  }
  run(interaction) {
    ...
    if (!command) {
      client.emit(Events_js.Events.UnknownContextMenuCommand, {
        interaction,
    ...
    if (!command.contextMenuRun) {
      client.emit(Events_js.Events.CommandDoesNotHaveContextMenuCommandHandler, {
        command,
        interaction,
        context: { commandId: interaction.commandId, commandName: interaction.commandName }
      });
    ...
    client.emit(Events_js.Events.PreContextMenuCommandRun, {
      command,
      context: { commandId: interaction.commandId, commandName: interaction.commandName },
      interaction
    });
...
//# sourceMappingURL=CorePossibleContextMenuCommand.js.map